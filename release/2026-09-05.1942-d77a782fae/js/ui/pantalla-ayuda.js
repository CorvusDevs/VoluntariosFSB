...
const VERSION_AYUDA_RECIENTE = '2.2.0'
...
const PREGUNTAS_AYUDA_BASE = [
  ...
  { categoria: 'Comunicación visual', fuente: 'Versión 2.1.5', pregunta: '¿Puedo cambiar los colores, el logo y las firmas de un certificado?', respuesta: 'Sí. Las firmas están visibles en la sección Firmas, sin abrir Personalización avanzada. Podés agregar un PNG con fondo transparente para cada firmante y quitarlo cuando quieras. En Personalización avanzada se mantienen los colores, la marca de agua, la escala del texto, el logotipo, los datos de contacto y los nombres y cargos. El nombre, cargo y línea continúan visibles debajo. Los cambios se aplican al lote completo y se ven antes de descargar. Los datos importados, el logotipo y las firmas elegidas se eliminan al salir del editor.', destino: 'cms-comunicacion-visual', accion: 'Personalizar certificados', palabrasClave: 'certificado personalizar colores logo logotipo firma PNG imagen firmantes contacto marca agua texto privacidad visible normal avanzada' },
