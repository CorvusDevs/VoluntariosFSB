...
const PREGUNTAS_ACTUALIZADAS = new Map([
  ...
  ['¿Cómo sé dónde registrar una idea o pedido?', {
    ...
    respuesta: 'Abrí Centro de trabajo, elegí Crear y luego Captura rápida. Describí brevemente lo que necesitás. El gestor propone una tarea, un pedido, una actividad, un proyecto, una nota o una reunión, y sugiere el equipo responsable. Revisá siempre la propuesta antes de guardar.',
  }],
...
const PREGUNTAS_NUEVAS = [
  ...
  { categoria: 'Proyectos y tareas', fuente: 'Versión 2.0.1', pregunta: '¿Qué hago si no tengo permiso para crear una tarea?', respuesta: 'Elegí Enviar solicitud o Pedido a un equipo. La solicitud registra qué necesitás, quién la envió y qué equipo debe revisarla. No evita los permisos ni crea una asignación silenciosa. El equipo puede ordenar el pedido y convertirlo en trabajo según su funcionamiento.', destino: 'cms-trabajo', accion: 'Enviar solicitud', palabrasClave: 'sin permiso no puedo crear tarea solicitar pedido equipo alternativa' },
